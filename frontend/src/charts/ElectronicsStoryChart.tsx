...
export function ElectronicsStoryChart({ series }: { series: ElectronicsProductSeries[] }) {
  ...
  const option = useMemo(() => ({
    ...
    textStyle: { fontFamily: 'Manrope, ui-sans-serif, system-ui', color: '#82908b' },
    ...
    legend: { type: 'scroll', top: 10, left: 4, right: 94, textStyle: { color: '#82908b' } },
    tooltip: {
      trigger: 'axis',
      backgroundColor: '#081614',
      borderColor: '#315b54',
      textStyle: { color: '#f2f3ea' },
    ...
    yAxis: { type: 'value', name: 'Official U.S. starting price', axisLabel: { formatter: '${value}' }, splitLine: { lineStyle: { color: 'rgba(117,129,125,.16)' } } },
